                        ...
                        foreach (KeyValuePair<string, Person> thisEntry in people.sortedList)
                        {
                            ...
                            if (thisPerson.GetType() == typeof(Student))
                            {
                                ...
                                foreach (string courseCode in student.courseCodes)
                                {
                                    ...
                                    Console.Write("{0} - {1} ", thisCourse.courseCode, thisCourse.description);
                                    foreach (DayOfWeek dayOfWeek in thisCourse.schedule.daysOfWeek)
                                    {
                                        Console.Write("{0} ", dayOfWeek);
                                    }
                                    Console.Write("{0:hh:mmtt} - {1:hh:mmtt}", thisCourse.schedule.startTime, thisCourse.schedule.endTime);
                                    Console.WriteLine();
                                }
                            }
        ...
        public static void EditPerson(ref Person thisPerson)
        {
            ...
            if (thisPerson.GetType() == typeof(Student))
            {
                ...
                do
                {
                    ...
                    thisStudent.courseCodes.Add(inputString);
                } while (true);
            }
