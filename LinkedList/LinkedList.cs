    ...
    public partial class LinkedList : Form
    {
       ...
       */
        ...
        private void Button4__Click(object sender, EventArgs e)
        {
            ...
            LinkedList<object> linkedList = new LinkedList<object>();
            LinkedListNode<object> linkedListNode;
            string s1 = "Because I'm sad Clap along if you feel like a room without a roof Because I'm sad Clap along if you feel like sadness is the truth sad";
            string[] s = null;
            s = s1.Split(' ');
        ...
        private void Button5__Click(object sender, EventArgs e)
        {
            ...
            // 2. Your code here
            string s1 = "The Spain in rain falls plain on the mainly";
            s = s1.Split(' ');
            foreach (string word in s)
            {
                linkedList.AddLast(word);
            ...
            linkedList.Remove(linkedListNode1);
            linkedListNode2 = linkedList.Find("The");
            linkedList.AddAfter(linkedListNode2, linkedListNode1);
